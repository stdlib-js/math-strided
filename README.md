...
```javascript
import { special } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided@deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-strided/actions/workflows/test.yml/badge.svg?branch=v0.0.7
[test-url]: https://github.com/stdlib-js/math-strided/actions/workflows/test.yml?query=branch:v0.0.7
